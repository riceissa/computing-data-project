insert into cloud_instances(name, ram, cpu, ecu, processor, network_throughput, storage_type, cost, date_observed, region, operating_system) values
    ...
    ,('m5.xlarge',0.192,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m5.2xlarge',0.384,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m5.4xlarge',0.768,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m5.12xlarge',2.304,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m5.24xlarge',4.608,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m4.large',0.1,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m4.xlarge',0.2,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m4.2xlarge',0.4,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m4.4xlarge',0.8,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m4.10xlarge',2,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m4.16xlarge',3.2,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m3.medium',0.067,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m3.large',0.133,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m3.xlarge',0.266,'2017-12-01','US East (N. Virginia)','Linux')
    ,('m3.2xlarge',0.532,'2017-12-01','US East (N. Virginia)','Linux')
